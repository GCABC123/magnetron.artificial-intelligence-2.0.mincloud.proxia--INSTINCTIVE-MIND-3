# -magnetron.artificial-intelligence-2.0.mincloud.proxia--INSTINCTIVE-MIND-3
...
🌐 ARTIFICIAL INTELLIGENCE 2.0 ™ : OBJECT MASKING PROXIA A (SEGMENTATION & OBJECT DETECTION). (SENSE: VISION_EYE CAMERAS)
...
NOTE: THIS NOTEBOOK INVOLVES OBJECT DETECTION AND SEGMENTATION WITH RCNN (REGION-BASED CONVOLUTIONAL NEURAL NETWORK), AS OPPOSED TO OBJECT DETECTION WITH YOLO (OR OTHER).

NOTE: DETECTRON2 (FROM FACEBOOK AI RESEARCH) ALSO DOES POSE ESTIMATION WITH DENSEPOSE. DETECTRON2 IS AVAILABLE HERE: https://github.com/facebookresearch/detectron2 
